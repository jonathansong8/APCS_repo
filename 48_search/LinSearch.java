/**
   ...
   Disco: 
   - Comparable is a data type that encompasses ints, strings, and presumably, other types that can be compared with .equals
   - Comparables do not work with math operators
   QCC: What isn't a comparable?
**/
